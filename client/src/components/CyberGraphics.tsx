    ...
    >
      ...
      <defs>
        <pattern id="circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <circle cx="50" cy="50" r="1.5" fill="#ff0000" />
        </pattern>
      </defs>
      ...
      {/* Data Flow Lines */}
      <path d="M100 200 Q300 100 500 200 T900 150" stroke="#ff0000" strokeWidth="2" fill="none" className="animate-pulse" />
...
export const FloatingIcons: FC = () => (
  <div className="absolute inset-0 pointer-events-none">
    ...
    <div className="absolute top-10 left-10 group cursor-pointer">
      <svg className="w-8 h-8 text-red-500/30 animate-bounce group-hover:text-red-500/60 transition-all duration-300 group-hover:scale-125" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="absolute -inset-2 bg-red-500/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse"></div>
    </div>
    ...
    <div className="absolute top-1/3 right-10 group cursor-pointer">
      <svg className="w-5 h-5 text-red-500/30 animate-pulse group-hover:text-red-500/60 transition-all duration-300 group-hover:scale-125" viewBox="0 0 24 24" fill="currentColor" style={{ animationDelay: '1.5s' }}>
...
export const HeroBackground: FC = () => (
  <div className="absolute inset-0">
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-900 to-red-950/30"></div>
      ...
      <svg width="100%" height="100%" viewBox="0 0 800 600" fill="none">
        <defs>
          <pattern id="cyber-grid" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
            ...
            <circle cx="25" cy="25" r="1.5" fill="#ff0000" opacity="0.8" className="animate-pulse"/>
    ...
    <div className="absolute bottom-1/4 right-1/3 w-64 h-64 bg-red-400/8 rounded-full blur-2xl animate-pulse hover:bg-red-400/15 transition-all duration-1000" style={{ animationDelay: '2s' }}></div>
